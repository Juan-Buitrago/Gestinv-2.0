...
<html>
    ...
    <form name="saveArticulos" action ="controller/remisiones.Controller.php" method ="POST">
        <table width="700">
            <tr> 
    ...
    <form name="saveArticulos" action ="controller/remisiones.controller.php" method ="POST">
        ...
        <table>
            <tr> 
                ...
                <td>
                     <form name="impresion" action ="controller/remisiones.controller.php" method ="POST"><input type = "hidden" name ="id" value="' . @$save['header']['header']['pk_id'] . '"><button>Imprimir</button></form>
                </td>
                <td>
                     <a name="finalizar" href="remisiones"><button>Finalizar</button></a></li>
                </td>
